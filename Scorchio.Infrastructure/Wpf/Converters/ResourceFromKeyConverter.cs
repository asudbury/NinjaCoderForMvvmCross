// --------------------------------------------------------------------------------------------------------------------
// <summary>
//    Defines the ResourceFromKeyConverter type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace Scorchio.Infrastructure.Wpf.Converters
{
    ...
    public class ResourceFromKeyConverter : IMultiValueConverter
    {
        /// <summary>
        ...
        public object Convert(
            ...
            CultureInfo culture)
        {
            UserControl targetObject = values[0] as UserControl;

            return targetObject == null ? 
                DependencyProperty.UnsetValue : 
                targetObject.TryFindResource(values[1]);
        }
