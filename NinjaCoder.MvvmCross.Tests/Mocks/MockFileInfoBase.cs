// --------------------------------------------------------------------------------------------------------------------
// <summary>
//    Defines the MockFileInfoBase type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace NinjaCoder.MvvmCross.Tests.Mocks
{
    ...
    public class MockFileInfoBase : FileInfoBase
    {
        ...
        /// </summary>
        public DateTime LastWriteTimeValue { get; set; }
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="MockFileInfoBase"/> is exists.
        /// </summary>
        ...
        {
            get { return this.LastWriteTimeValue; }
            set { }
        }
        ...
        /// <returns>A FileInfoBase</returns>
